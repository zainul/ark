...
import (
	...
	"github.com/zainul/ark/log/logger"
)
...
// SetStdLog will be the entry point for tdk logging library to make sure all ark services have the same log structures.
// The general specification will be JSON, request id, context id, metadata, error and message.
// For more specifications please go to https://ark.atlassian.net/wiki/spaces/EN/pages/694817819/Logging+Format+Standardization
